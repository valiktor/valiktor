...
import org.valiktor.functions.MoneyFunctionsFixture.Employee
...
private object MoneyFunctionsFixture {

    data class Employee(val salary: Money? = null)
}
...
class MoneyFunctionsTest {
    ...
    fun `isLessThan with negative less value should be valid`() {
        validate(Employee(salary = moneyOf(BRL, 0.38.unaryMinus().toBigDecimal()))) {
    ...
    fun `isGreaterThanOrEqualTo with negative greater value should be valid`() {
        validate(Employee(salary = moneyOf(BRL, 0.3.unaryMinus().toBigDecimal()))) {
            validate(Employee::salary).isGreaterThanOrEqualTo(moneyOf(BRL, 0.38.unaryMinus().toBigDecimal()))
        }
    }
    ...
    fun `isPositive with negative value should be invalid`() {
        val exception = assertFailsWith<ConstraintViolationException> {
            validate(Employee(salary = moneyOf(BRL, 98765.43.unaryMinus().toBigDecimal()))) {
                validate(Employee::salary).isPositive()
            }
        }
        ...
        assertThat(exception.constraintViolations).containsExactly(
            DefaultConstraintViolation(
                property = "salary",
                value = moneyOf(BRL, 98765.43.unaryMinus().toBigDecimal()),
    ...
    fun `isNegativeOrZero with negative value should be valid`() {
        validate(Employee(salary = moneyOf(USD, 98765.43.unaryMinus().toBigDecimal()))) {
            validate(Employee::salary).isNegativeOrZero()
        }
    }
    ...
    fun `isPositiveOrZero with negative value should be invalid`() {
        ...
        assertThat(exception.constraintViolations).containsExactly(
            DefaultConstraintViolation(
                property = "salary",
                value = moneyOf(USD, 98765.43.unaryMinus().toBigDecimal()),
    ...
    fun `hasDecimalDigits with valid min value should be valid`() {
        validate(Employee(salary = moneyOf(USD, 99.99.toBigDecimal()))) {
            validate(Employee::salary).hasDecimalDigits(min = 2)
        }
    }

    @Test
    fun `hasDecimalDigits with valid max value should be valid`() {
        validate(Employee(salary = moneyOf(BRL, 99.99.toBigDecimal()))) {
    ...
    fun `hasDecimalDigits with valid min and max value should be valid`() {
        validate(Employee(salary = moneyOf(USD, 99.99.toBigDecimal()))) {
            validate(Employee::salary).hasDecimalDigits(min = 2, max = 2)
        }
    }

    @Test
    fun `hasDecimalDigits with negative valid min value should be valid`() {
        validate(Employee(salary = moneyOf(BRL, 99.99.unaryMinus().toBigDecimal()))) {
            validate(Employee::salary).hasDecimalDigits(min = 2)
        }
    }
    ...
    fun `hasDecimalDigits with negative valid max value should be valid`() {
        validate(Employee(salary = moneyOf(USD, 99.99.unaryMinus().toBigDecimal()))) {
            validate(Employee::salary).hasDecimalDigits(max = 2)
        }
    }
    ...
    fun `hasDecimalDigits with less min value should be invalid`() {
        val exception = assertFailsWith<ConstraintViolationException> {
            validate(Employee(salary = moneyOf(BRL, 78.74.toBigDecimal()))) {
        ...
        assertThat(exception.constraintViolations).containsExactly(
            DefaultConstraintViolation(
                property = "salary",
                value = moneyOf(BRL, 78.74.toBigDecimal()),
    ...
    fun `hasDecimalDigits with greater max value should be invalid`() {
        val exception = assertFailsWith<ConstraintViolationException> {
            validate(Employee(salary = moneyOf(USD, 78.74.toBigDecimal()))) {
                validate(Employee::salary).hasDecimalDigits(max = 1)
            }
        }
        ...
        assertThat(exception.constraintViolations).containsExactly(
            DefaultConstraintViolation(
                property = "salary",
                value = moneyOf(USD, 78.74.toBigDecimal()),
    ...
    fun `hasDecimalDigits with negative less min value should be invalid`() {
        val exception = assertFailsWith<ConstraintViolationException> {
            validate(Employee(salary = moneyOf(BRL, 78.74.unaryMinus().toBigDecimal()))) {
                validate(Employee::salary).hasDecimalDigits(min = 7)
            }
        }
        ...
        assertThat(exception.constraintViolations).containsExactly(
            DefaultConstraintViolation(
                property = "salary",
                value = moneyOf(BRL, 78.74.unaryMinus().toBigDecimal()),
                constraint = DecimalDigits(min = 7)
            )
        )
    }
    ...
    fun `hasDecimalDigits with negative greater max value should be invalid`() {
        val exception = assertFailsWith<ConstraintViolationException> {
            validate(Employee(salary = moneyOf(USD, 78.74.unaryMinus().toBigDecimal()))) {
                validate(Employee::salary).hasDecimalDigits(max = 1)
            }
        }
        ...
        assertThat(exception.constraintViolations).containsExactly(
            DefaultConstraintViolation(
                property = "salary",
                value = moneyOf(USD, 78.74.unaryMinus().toBigDecimal()),
                constraint = DecimalDigits(max = 1)
            )
        )
    }
