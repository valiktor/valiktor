...
class ArrayFormatterTest {
    ...
    fun `should format Array of Any`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(ArrayFormatterFixture.TestObject, ArrayFormatterFixture.TestObject))).contains(
    ...
    fun `should format Array of Enum`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(ArrayFormatterFixture.TestEnum.E1, ArrayFormatterFixture.TestEnum.E2))).contains(
    ...
    fun `should format Array of String`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf("test1", "test2"))).contains(
    ...
    fun `should format Array of Char`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf('A', 'B'))).contains(
    ...
    fun `should format Array of Boolean`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(true, false))).contains(
    ...
    fun `should format Array of Byte`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(1.toByte(), 50.toByte(), 100.unaryMinus().toByte()))).contains(
    ...
    fun `should format Array of Short`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(0.toShort(), 123.toShort(), 987.unaryMinus().toShort(), 1_234.toShort(), 9_876.unaryMinus().toShort()))).contains(
    ...
    fun `should format Array of Int`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(0, 123, -987, 1_234_567, -9_876_543))).contains(
    ...
    fun `should format Array of Long`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(0L, 123L, -987L, 1_234_567_891_235_987_587L, -9_876_543_549_852_546L))).contains(
    ...
    fun `should format Array of Float`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(0.0f, 123f, -987f, 1_234.12f, -9_876.789f))).contains(
    ...
    fun `should format Array of Double`() {
        assertThat(Formatters[Array<Any>::class].formatAllSupportedLocales(arrayOf(0.0, 123, -987, 132_234.12345678, -129_876.789876))).contains(
