 ...
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Char?>.isLessThan(value: Char): Validator<E>.Property<Char?> =
        this.validate(Less(value), { it == null || it < value })

/**
 * Validates if the [Char] property is less than or equal to another value
 *
 * @property value specifies the value that should be validated
 *
 * @receiver the property to be validated
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Char?>.isLessThanOrEqualTo(value: Char): Validator<E>.Property<Char?> =
        this.validate(LessOrEqual(value), { it == null || it <= value })

/**
 * Validates if the [Char] property is greater than another value
 *
 * @property value specifies the value that should be validated
 *
 * @receiver the property to be validated
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Char?>.isGreaterThan(value: Char): Validator<E>.Property<Char?> =
        this.validate(Greater(value), { it == null || it > value })

/**
 * Validates if the [Char] property is greater than or equal to another value
 *
 * @property value specifies the value that should be validated
 *
 * @receiver the property to be validated
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Char?>.isGreaterThanOrEqualTo(value: Char): Validator<E>.Property<Char?> =
        this.validate(GreaterOrEqual(value), { it == null || it >= value })

/**
 * Validates if the [Char] property is between two values
 *
 ...
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Char?>.isBetween(start: Char, end: Char): Validator<E>.Property<Char?> =
        this.validate(Between(start, end), { it == null || it in start.rangeTo(end) })

/**
 * Validates if the [Char] property isn't between two values
 *
 ...
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Char?>.isNotBetween(start: Char, end: Char): Validator<E>.Property<Char?> =
